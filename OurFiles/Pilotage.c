...
Trame Presence_Assiette(void)
{
	...
	Presence[0] = 0xC1;
	Presence[1] = REPONSE_PRESENCE_ASSIETTE;
...
Trame Presence_Aspirateur (void)
{
	...
	Presence[0] = 0xC1;
	Presence[1] = REPONSE_PRESENCE_ASPIRATEUR;
