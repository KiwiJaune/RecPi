...
#define DEFAULT_KD		70						// Coefficient derive
...
#define VOIE			280*1.010200964882001//1.01*1.00051*0.9995701848205272*1.000119						// Distance entre les deux roues en mm
...
#define DEFAULT_ACCEL	1000			// Acceleration par défaut en mm/s^2
#define ERROR_ALLOWED	0				// En cas de sifflement moteur intempestif (en pas)


#define DIRG 	LATBbits.LATB12//LATAbits.LATA10
#define DIRD 	LATBbits.LATB14//LATAbits.LATA7
